...
(function () {
  ...
  var CSS = [
    ...
    '  background: #1a1a1a; color: #e8e8e8; border-top: 1px solid #333;',
    ...
    '}',
    '#sat-consent-text { flex: 1; min-width: 260px; }',
    '#sat-consent-text h2 {',
    '  margin: 0 0 6px; font-size: 15px; font-weight: 600; color: #fff;',
    '}',
    '#sat-consent-text p { margin: 0; line-height: 1.5; color: #c8c8c8; }',
